...
<div class="py-16 white">  
    <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
        ...
        <div class="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
          <div class="row-span-2 p-6  rounded-xl bg-gray-50 text-center sm:p-8 hakuna">
          ...
          <div class="p-6  rounded-xl bg-gray-50 sm:flex sm:space-x-8 sm:p-8 hakuna">
          ...
          <div class="p-6rounded-xl bg-gray-50 sm:flex sm:space-x-8 sm:p-8 hakuna">
