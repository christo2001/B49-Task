...
function About() {
  return (
    <div className='about'>
      ...
      <div className='textcenter'>WELCOME TO <span className='textcenter-span'>ROYAL CARS</span></div>
      </div>
    ...
    <div class="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
                ...
                <div class="lg:max-w-xl lg:pr-5 relative z-40 abox">
                    ...
                    <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        We make you 
                        <span class="my-1 inline-block border-b-8 border-g4 bg-black px-4 font-bold text-g4 animate__animated animate__flash">different</span>
                    </h2>
                    <p class="text-base text-gray-700">Royal Cars is a premier car rental company that offers an unparalleled experience in luxury and convenience. Whether you're embarking on a business trip, a family vacation, or simply seeking a stylish ride for a special occasion, Royal Cars stands as a reliable companion in the world of exquisite transportation. With a fleet of meticulously maintained vehicles, ranging from iconic brands like Mercedes and BMW to the adventurous allure of a Hummer, 
                    Royal Cars ensures that every journey is not just a commute but a statement in sophistication.</p>
