...
router.post("/registered", async (req, res) => {
  try {
    ...
    const verify = `https://6568eee3e2501f05c2df516b--relaxed-faun-da5d5a.netlify.app/verify/:token`;
...
router.post("/forgetpassword", async (req, res) => {
  try {
    ...
    const content = `<p>Access to change your old password</p>
      <a href="https://6568eee3e2501f05c2df516b--relaxed-faun-da5d5a.netlify.app/change/:token">"${token}"</a>`;
